...
async function addSeedData() {
  ...
  const westd = `INSERT INTO addresses(uuid,streetname,postcode,town) VALUES(1000,'West drayton Rd ', 'UB7 7EQ', 'West Drayton')`;
  ...
  const macdees = `INSERT INTO restaurants(name,address_id,telephone,description,start_time,end_time,current_slots, imageURL, logoURL)
  			VALUES('McDonalds',1000,111,'We are a fast food restaurant which sells poor quality food pls buy from us if you want to get fatfat :).' , '03:01:00',' 03:02:00', 100, 'https://images.barrons.com/im-269232?width=1280&size=1.33333333', 'https://cdn.iconscout.com/icon/free/png-256/mcdonalds-3384870-2822951.png')`;
