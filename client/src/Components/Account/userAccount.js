            ...
            <div className="px-4 py-5 flex-none ">
              <div className="tab-content tab-space">
                <div className={openTab === 1 ? "block" : "hidden"} id="link1">
                  <AccountTab customerId={accountDetails.customer_id} email={accountDetails.email} telephone={accountDetails.telephone}></AccountTab>
                </div>
                ...
                <div className={openTab === 3 ? "block" : "hidden"} id="link3">
                  <CustomerOrdersTab customerId={accountDetails.customer_id}></CustomerOrdersTab>
                </div>
              </div>
            </div>
          </div>
